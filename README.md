...
3. Go to `cc0/`
4. Run `./build.sh`
5. `cc0` will be in `cc0/build/release/` directory
...
Make sure that `~/.local/bin` is in your `PATH` environment variable. You can now type `cc0 --help` and start.
...
8. Resulting binary will be `build/cc0.exe`

Or.

7. Open generated solution `build/cc0.sln` in Visual Studio and build yourself.
