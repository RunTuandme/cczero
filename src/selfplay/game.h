...
class SelfPlayGame {
   public:
    ...
    SelfPlayGame(PlayerOptions player1, PlayerOptions player2,
                 bool shared_tree);
    ...
    // Gets the eval which required the biggest swing up to get the final
    // outcome. Eval is the expected outcome in the range 0<->1.
